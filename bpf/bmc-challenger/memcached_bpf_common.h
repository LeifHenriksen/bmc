...
#define CACHE_ENTRY_COUNT 2777777 //max: 4194299, 12201599 for 32-byte values, 2777777 is a tenth of memcached, 6944444 for 25%
#define MAX_PACKET_LENGTH 1500
#define MAX_KEY_IN_PACKET MAX_KEY_IN_MULTIGET

#define CACHE_ENTRY_LIFEPOINTS 16
